...
class AuthConfigFieldSpec(BaseModel):
    ...
    airbyte_secret: bool | None = None


class AuthConfigSpec(BaseModel):
    """
    ...
    def validate_config_structure(self) -> "AuthConfigSpec":
...
class SecurityScheme(BaseModel):
    ...
    x_airbyte_auth_config: AuthConfigSpec | None = Field(None, alias="x-airbyte-auth-config")
