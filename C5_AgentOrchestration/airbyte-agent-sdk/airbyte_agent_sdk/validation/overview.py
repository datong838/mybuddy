...
from airbyte_agent_sdk.validation.readiness import build_cassette_map, validate_connector_readiness
...
def compute_golden_questions_hash(connector_yaml_path: str | Path) -> str:
    ...
    is stale relative to the current connector definition::
        ...
        from airbyte_agent_sdk.validation.overview import compute_golden_questions_hash
        import yaml
