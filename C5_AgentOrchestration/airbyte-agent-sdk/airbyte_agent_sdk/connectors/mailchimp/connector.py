...
class MailchimpConnector:
    ...
    _ACCEPTED_AUTH_TYPES = (MailchimpAuthConfig, AirbyteAuthConfig)

    def __init__(
        self,
        auth_config: MailchimpAuthConfig | AirbyteAuthConfig | BaseModel | None = None,
        ...
        if is_hosted:
            ...
            if not auth_config:
                raise ValueError(
                    ...
                    "or MailchimpAuthConfig for local mode"
                )
