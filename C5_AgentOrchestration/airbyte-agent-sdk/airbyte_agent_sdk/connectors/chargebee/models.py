...
class Customer(BaseModel):
    ...
    auto_collection: str | None = Field(default=None)
    offline_payment_method: str | None = Field(default=None)
    net_term_days: int | None = Field(default=None)
    vat_number_validated_time: int | None = Field(default=None)
    vat_number_status: str | None = Field(default=None)
    allow_direct_debit: bool | None = Field(default=None)
    is_location_valid: bool | None = Field(default=None)
    created_at: int | None = Field(default=None)
    created_from_ip: str | None = Field(default=None)
    taxability: str | None = Field(default=None)
    entity_code: str | None = Field(default=None)
    exempt_number: str | None = Field(default=None)
    resource_version: int | None = Field(default=None)
    updated_at: int | None = Field(default=None)
    locale: str | None = Field(default=None)
    billing_date: int | None = Field(default=None)
    billing_date_mode: str | None = Field(default=None)
    billing_day_of_week: str | None = Field(default=None)
    billing_day_of_week_mode: str | None = Field(default=None)
    billing_month: int | None = Field(default=None)
    pii_cleared: str | None = Field(default=None)
    auto_close_invoices: bool | None = Field(default=None)
    channel: str | None = Field(default=None)
    fraud_flag: str | None = Field(default=None)
    primary_payment_source_id: str | None = Field(default=None)
    backup_payment_source_id: str | None = Field(default=None)
    invoice_notes: str | None = Field(default=None)
    business_entity_id: str | None = Field(default=None)
    preferred_currency_code: str | None = Field(default=None)
    promotional_credits: int | None = Field(default=None)
    unbilled_charges: int | None = Field(default=None)
    refundable_credits: int | None = Field(default=None)
    excess_payments: int | None = Field(default=None)
    deleted: bool | None = Field(default=None)
    registered_for_gst: bool | None = Field(default=None)
    consolidated_invoicing: bool | None = Field(default=None)
    customer_type: str | None = Field(default=None)
    business_customer_without_vat_number: bool | None = Field(default=None)
    client_profile_id: str | None = Field(default=None)
    use_default_hierarchy_settings: bool | None = Field(default=None)
    vat_number_prefix: str | None = Field(default=None)
    billing_address: dict[str, Any] | None = Field(default=None)
    referral_urls: list[dict[str, Any]] | None = Field(default=None)
    contacts: list[dict[str, Any]] | None = Field(default=None)
    payment_method: dict[str, Any] | None = Field(default=None)
    balances: list[dict[str, Any]] | None = Field(default=None)
    relationship: dict[str, Any] | None = Field(default=None)
    parent_account_access: dict[str, Any] | None = Field(default=None)
    child_account_access: dict[str, Any] | None = Field(default=None)
    meta_data: dict[str, Any] | None = Field(default=None)
    mrr: int | None = Field(default=None)
    exemption_details: list[dict[str, Any]] | None = Field(default=None)
    tax_providers_fields: list[dict[str, Any]] | None = Field(default=None)
...
class CustomerList(BaseModel):
    ...
    list_: list[CustomerListListItem] | None = Field(default=None, alias="list")
    next_offset: str | None = Field(default=None)
...
class Subscription(BaseModel):
    ...
    plan_quantity: int | None = Field(default=None)
    plan_unit_price: int | None = Field(default=None)
    plan_amount: int | None = Field(default=None)
    plan_free_quantity: int | None = Field(default=None)
    status: str | None = Field(default=None)
    trial_start: int | None = Field(default=None)
    trial_end: int | None = Field(default=None)
    current_term_start: int | None = Field(default=None)
    current_term_end: int | None = Field(default=None)
    next_billing_at: int | None = Field(default=None)
    created_at: int | None = Field(default=None)
    started_at: int | None = Field(default=None)
    activated_at: int | None = Field(default=None)
    cancelled_at: int | None = Field(default=None)
    cancel_reason: str | None = Field(default=None)
    channel: str | None = Field(default=None)
    billing_period: int | None = Field(default=None)
    billing_period_unit: str | None = Field(default=None)
    auto_collection: str | None = Field(default=None)
    currency_code: str | None = Field(default=None)
    remaining_billing_cycles: int | None = Field(default=None)
    po_number: str | None = Field(default=None)
    created_from_ip: str | None = Field(default=None)
    resource_version: int | None = Field(default=None)
    updated_at: int | None = Field(default=None)
    has_scheduled_changes: bool | None = Field(default=None)
    payment_source_id: str | None = Field(default=None)
    plan_free_quantity_in_decimal: str | None = Field(default=None)
    plan_quantity_in_decimal: str | None = Field(default=None)
    plan_unit_price_in_decimal: str | None = Field(default=None)
    plan_amount_in_decimal: str | None = Field(default=None)
    due_invoices_count: int | None = Field(default=None)
    due_since: int | None = Field(default=None)
    total_dues: int | None = Field(default=None)
    mrr: int | None = Field(default=None)
    exchange_rate: float | None = Field(default=None)
    base_currency_code: str | None = Field(default=None)
    override_relationship: bool | None = Field(default=None)
    trial_end_action: str | None = Field(default=None)
    pause_date: int | None = Field(default=None)
    resume_date: int | None = Field(default=None)
    cancelled_at_term_end: bool | None = Field(default=None)
    has_scheduled_advance_invoices: bool | None = Field(default=None)
    object_: str | None = Field(default=None, alias="object")
    addons: list[dict[str, Any]] | None = Field(default=None)
    coupons: list[dict[str, Any]] | None = Field(default=None)
    discounts: list[dict[str, Any]] | None = Field(default=None)
    subscription_items: list[dict[str, Any]] | None = Field(default=None)
    item_tiers: list[dict[str, Any]] | None = Field(default=None)
    charged_items: list[dict[str, Any]] | None = Field(default=None)
    shipping_address: dict[str, Any] | None = Field(default=None)
    contract_term: dict[str, Any] | None = Field(default=None)
    meta_data: dict[str, Any] | None = Field(default=None)
    deleted: bool | None = Field(default=None)
    business_entity_id: str | None = Field(default=None)
    free_period: int | None = Field(default=None)
    free_period_unit: str | None = Field(default=None)
    cf_mandate_id: str | None = Field(default=None)
    custom_fields: list[dict[str, Any]] | None = Field(default=None)
    changes_scheduled_at: int | None = Field(default=None)
    invoice_notes: str | None = Field(default=None)
    auto_close_invoices: bool | None = Field(default=None)
    offline_payment_method: str | None = Field(default=None)
...
class SubscriptionList(BaseModel):
    ...
    list_: list[SubscriptionListListItem] | None = Field(default=None, alias="list")
    next_offset: str | None = Field(default=None)
...
class Invoice(BaseModel):
    ...
    amount_adjusted: int | None = Field(default=None)
    write_off_amount: int | None = Field(default=None)
    credits_applied: int | None = Field(default=None)
    amount_due: int | None = Field(default=None)
    paid_at: int | None = Field(default=None)
    dunning_status: str | None = Field(default=None)
    updated_at: int | None = Field(default=None)
    resource_version: int | None = Field(default=None)
    deleted: bool | None = Field(default=None)
    object_: str | None = Field(default=None, alias="object")
    first_invoice: bool | None = Field(default=None)
    amount_to_collect: int | None = Field(default=None)
    round_off_amount: int | None = Field(default=None)
    new_sales_amount: int | None = Field(default=None)
    has_advance_charges: bool | None = Field(default=None)
    tax: int | None = Field(default=None)
    sub_total: int | None = Field(default=None)
    sub_total_in_local_currency: int | None = Field(default=None)
    total_in_local_currency: int | None = Field(default=None)
    exchange_rate: float | None = Field(default=None)
    base_currency_code: str | None = Field(default=None)
    is_gifted: bool | None = Field(default=None)
    generated_at: int | None = Field(default=None)
    expected_payment_date: int | None = Field(default=None)
    channel: str | None = Field(default=None)
    business_entity_id: str | None = Field(default=None)
    line_items: list[dict[str, Any]] | None = Field(default=None)
    discounts: list[dict[str, Any]] | None = Field(default=None)
    line_item_discounts: list[dict[str, Any]] | None = Field(default=None)
    taxes: list[dict[str, Any]] | None = Field(default=None)
    line_item_taxes: list[dict[str, Any]] | None = Field(default=None)
    line_item_tiers: list[dict[str, Any]] | None = Field(default=None)
    linked_payments: list[dict[str, Any]] | None = Field(default=None)
    dunning_attempts: list[dict[str, Any]] | None = Field(default=None)
    applied_credits: list[dict[str, Any]] | None = Field(default=None)
    adjustment_credit_notes: list[dict[str, Any]] | None = Field(default=None)
    issued_credit_notes: list[dict[str, Any]] | None = Field(default=None)
    linked_orders: list[dict[str, Any]] | None = Field(default=None)
    notes: list[dict[str, Any]] | None = Field(default=None)
    billing_address: dict[str, Any] | None = Field(default=None)
    shipping_address: dict[str, Any] | None = Field(default=None)
    linked_taxes_withheld: list[dict[str, Any]] | None = Field(default=None)
    custom_fields: list[dict[str, Any]] | None = Field(default=None)
    void_reason_code: str | None = Field(default=None)
    voided_at: int | None = Field(default=None)
    created_at: int | None = Field(default=None)
...
class InvoiceList(BaseModel):
    ...
    list_: list[InvoiceListListItem] | None = Field(default=None, alias="list")
    next_offset: str | None = Field(default=None)
...
class CreditNote(BaseModel):
    ...
    customer_id: str | None = Field(default=None)
    subscription_id: str | None = Field(default=None)
    reference_invoice_id: str | None = Field(default=None)
    ...
    currency_code: str | None = Field(default=None)
    total: int | None = Field(default=None)
    amount_allocated: int | None = Field(default=None)
    amount_refunded: int | None = Field(default=None)
    amount_available: int | None = Field(default=None)
    refunded_at: int | None = Field(default=None)
    voided_at: int | None = Field(default=None)
    generated_at: int | None = Field(default=None)
    resource_version: int | None = Field(default=None)
    updated_at: int | None = Field(default=None)
    ...
    deleted: bool | None = Field(default=None)
    object_: str | None = Field(default=None, alias="object")
    create_reason_code: str | None = Field(default=None)
    void_reason_code: str | None = Field(default=None)
    fractional_correction: int | None = Field(default=None)
    line_items: list[dict[str, Any]] | None = Field(default=None)
    discounts: list[dict[str, Any]] | None = Field(default=None)
    line_item_discounts: list[dict[str, Any]] | None = Field(default=None)
    line_item_tiers: list[dict[str, Any]] | None = Field(default=None)
    taxes: list[dict[str, Any]] | None = Field(default=None)
    line_item_taxes: list[dict[str, Any]] | None = Field(default=None)
    linked_refunds: list[dict[str, Any]] | None = Field(default=None)
    allocations: list[dict[str, Any]] | None = Field(default=None)
    linked_tax_withheld_refunds: list[dict[str, Any]] | None = Field(default=None)
    shipping_address: dict[str, Any] | None = Field(default=None)
    billing_address: dict[str, Any] | None = Field(default=None)
    custom_fields: list[dict[str, Any]] | None = Field(default=None)
    created_at: int | None = Field(default=None)
...
class CreditNoteListListItem(BaseModel):
    ...
    credit_note: CreditNote | None = Field(default=None)

class CreditNoteList(BaseModel):
    """Paginated list of credit notes"""
    model_config = ConfigDict(extra="allow", populate_by_name=True)

    list_: list[CreditNoteListListItem] | None = Field(default=None, alias="list")
    next_offset: str | None = Field(default=None)
...
class Coupon(BaseModel):
    ...
    invoice_name: str | None = Field(default=None)
    ...
    discount_quantity: int | None = Field(default=None)
    currency_code: str | None = Field(default=None)
    duration_type: str | None = Field(default=None)
    duration_month: int | None = Field(default=None)
    valid_till: int | None = Field(default=None)
    max_redemptions: int | None = Field(default=None)
    status: str | None = Field(default=None)
    apply_discount_on: str | None = Field(default=None)
    apply_on: str | None = Field(default=None)
    plan_constraint: str | None = Field(default=None)
    addon_constraint: str | None = Field(default=None)
    created_at: int | None = Field(default=None)
    archived_at: int | None = Field(default=None)
    resource_version: int | None = Field(default=None)
    updated_at: int | None = Field(default=None)
    object_: str | None = Field(default=None, alias="object")
    redemptions: int | None = Field(default=None)
    invoice_notes: str | None = Field(default=None)
    period: int | None = Field(default=None)
    period_unit: str | None = Field(default=None)
    item_constraints: list[dict[str, Any]] | None = Field(default=None)
    item_constraint_criteria: list[dict[str, Any]] | None = Field(default=None)
    coupon_constraints: list[dict[str, Any]] | None = Field(default=None)
    deleted: bool | None = Field(default=None)
    custom_fields: list[dict[str, Any]] | None = Field(default=None)
...
class CouponListListItem(BaseModel):
    ...
    coupon: Coupon | None = Field(default=None)

class CouponList(BaseModel):
    """Paginated list of coupons"""
    model_config = ConfigDict(extra="allow", populate_by_name=True)

    list_: list[CouponListListItem] | None = Field(default=None, alias="list")
    next_offset: str | None = Field(default=None)
...
class Transaction(BaseModel):
    ...
    customer_id: str | None = Field(default=None)
    subscription_id: str | None = Field(default=None)
    gateway_account_id: str | None = Field(default=None)
    payment_source_id: str | None = Field(default=None)
    ...
    type_: str | None = Field(default=None, alias="type")
    date: int | None = Field(default=None)
    settled_at: int | None = Field(default=None)
    exchange_rate: float | None = Field(default=None)
    currency_code: str | None = Field(default=None)
    amount: int | None = Field(default=None)
    id_at_gateway: str | None = Field(default=None)
    status: str | None = Field(default=None)
    fraud_flag: str | None = Field(default=None)
    initiator_type: str | None = Field(default=None)
    three_d_secure: bool | None = Field(default=None)
    authorization_reason: str | None = Field(default=None)
    error_code: str | None = Field(default=None)
    error_text: str | None = Field(default=None)
    voided_at: int | None = Field(default=None)
    resource_version: int | None = Field(default=None)
    updated_at: int | None = Field(default=None)
    fraud_reason: str | None = Field(default=None)
    amount_unused: int | None = Field(default=None)
    masked_card_number: str | None = Field(default=None)
    reference_transaction_id: str | None = Field(default=None)
    refunded_txn_id: str | None = Field(default=None)
    reference_authorization_id: str | None = Field(default=None)
    amount_capturable: int | None = Field(default=None)
    reversal_transaction_id: str | None = Field(default=None)
    deleted: bool | None = Field(default=None)
    iin: str | None = Field(default=None)
    last4: str | None = Field(default=None)
    merchant_reference_id: str | None = Field(default=None)
    business_entity_id: str | None = Field(default=None)
    payment_method_details: Any | None = Field(default=None)
    object_: str | None = Field(default=None, alias="object")
    base_currency_code: str | None = Field(default=None)
    linked_invoices: list[dict[str, Any]] | None = Field(default=None)
    linked_credit_notes: list[dict[str, Any]] | None = Field(default=None)
    linked_refunds: list[dict[str, Any]] | None = Field(default=None)
    linked_payments: list[dict[str, Any]] | None = Field(default=None)
    custom_fields: list[dict[str, Any]] | None = Field(default=None)
    created_at: int | None = Field(default=None)
...
class TransactionList(BaseModel):
    ...
    list_: list[TransactionListListItem] | None = Field(default=None, alias="list")
    next_offset: str | None = Field(default=None)
...
class Event(BaseModel):
    ...
    object_: str | None = Field(default=None, alias="object")
    webhook_status: str | None = Field(default=None)
    webhooks: list[dict[str, Any]] | None = Field(default=None)
    custom_fields: list[dict[str, Any]] | None = Field(default=None)
...
class EventList(BaseModel):
    ...
    list_: list[EventListListItem] | None = Field(default=None, alias="list")
    next_offset: str | None = Field(default=None)
...
class Order(BaseModel):
    ...
    order_date: int | None = Field(default=None)
    shipping_date: int | None = Field(default=None)
    note: str | None = Field(default=None)
    tracking_id: str | None = Field(default=None)
    tracking_url: str | None = Field(default=None)
    batch_id: str | None = Field(default=None)
    created_by: str | None = Field(default=None)
    shipment_carrier: str | None = Field(default=None)
    invoice_round_off_amount: int | None = Field(default=None)
    tax: int | None = Field(default=None)
    amount_paid: int | None = Field(default=None)
    amount_adjusted: int | None = Field(default=None)
    refundable_credits_issued: int | None = Field(default=None)
    refundable_credits: int | None = Field(default=None)
    rounding_adjustement: int | None = Field(default=None)
    paid_on: int | None = Field(default=None)
    shipping_cut_off_date: int | None = Field(default=None)
    created_at: int | None = Field(default=None)
    status_update_at: int | None = Field(default=None)
    delivered_at: int | None = Field(default=None)
    shipped_at: int | None = Field(default=None)
    resource_version: int | None = Field(default=None)
    updated_at: int | None = Field(default=None)
    cancelled_at: int | None = Field(default=None)
    resent_status: str | None = Field(default=None)
    is_resent: bool | None = Field(default=None)
    original_order_id: str | None = Field(default=None)
    deleted: bool | None = Field(default=None)
    currency_code: str | None = Field(default=None)
    is_gifted: bool | None = Field(default=None)
    gift_note: str | None = Field(default=None)
    gift_id: str | None = Field(default=None)
    resend_reason: str | None = Field(default=None)
    business_entity_id: str | None = Field(default=None)
    object_: str | None = Field(default=None, alias="object")
    discount: int | None = Field(default=None)
    sub_total: int | None = Field(default=None)
    total: int | None = Field(default=None)
    order_line_items: list[dict[str, Any]] | None = Field(default=None)
    shipping_address: dict[str, Any] | None = Field(default=None)
    billing_address: dict[str, Any] | None = Field(default=None)
    line_item_taxes: list[dict[str, Any]] | None = Field(default=None)
    line_item_discounts: list[dict[str, Any]] | None = Field(default=None)
    linked_credit_notes: list[dict[str, Any]] | None = Field(default=None)
    resent_orders: list[dict[str, Any]] | None = Field(default=None)
    custom_fields: list[dict[str, Any]] | None = Field(default=None)
...
class OrderList(BaseModel):
    ...
    list_: list[OrderListListItem] | None = Field(default=None, alias="list")
    next_offset: str | None = Field(default=None)
...
class Item(BaseModel):
    ...
    id: str
    name: str | None = Field(default=None)
    external_name: str | None = Field(default=None)
    description: str | None = Field(default=None)
    status: str | None = Field(default=None)
    resource_version: int | None = Field(default=None)
    updated_at: int | None = Field(default=None)
    item_family_id: str | None = Field(default=None)
    type_: str | None = Field(default=None, alias="type")
    is_shippable: bool | None = Field(default=None)
    is_giftable: bool | None = Field(default=None)
    redirect_url: str | None = Field(default=None)
    enabled_for_checkout: bool | None = Field(default=None)
    enabled_in_portal: bool | None = Field(default=None)
    included_in_mrr: bool | None = Field(default=None)
    item_applicability: str | None = Field(default=None)
    gift_claim_redirect_url: str | None = Field(default=None)
    unit: str | None = Field(default=None)
    metered: bool | None = Field(default=None)
    usage_calculation: str | None = Field(default=None)
    archived_at: int | None = Field(default=None)
    channel: str | None = Field(default=None)
    metadata: dict[str, Any] | None = Field(default=None)
    deleted: bool | None = Field(default=None)
    object_: str | None = Field(default=None, alias="object")
    applicable_items: list[dict[str, Any]] | None = Field(default=None)
    bundle_items: list[dict[str, Any]] | None = Field(default=None)
    bundle_configuration: dict[str, Any] | None = Field(default=None)
    business_entity_id: str | None = Field(default=None)
    is_percentage_pricing: bool | None = Field(default=None)
...
class ItemList(BaseModel):
    ...
    list_: list[ItemListListItem] | None = Field(default=None, alias="list")
    next_offset: str | None = Field(default=None)
...
class ItemPrice(BaseModel):
    ...
    price_in_decimal: str | None = Field(default=None)
    period: int | None = Field(default=None)
    period_unit: str | None = Field(default=None)
    trial_period: int | None = Field(default=None)
    trial_period_unit: str | None = Field(default=None)
    trial_end_action: str | None = Field(default=None)
    shipping_period: int | None = Field(default=None)
    shipping_period_unit: str | None = Field(default=None)
    billing_cycles: int | None = Field(default=None)
    free_quantity: int | None = Field(default=None)
    free_quantity_in_decimal: str | None = Field(default=None)
    currency_code: str | None = Field(default=None)
    resource_version: int | None = Field(default=None)
    updated_at: int | None = Field(default=None)
    created_at: int | None = Field(default=None)
    archived_at: int | None = Field(default=None)
    invoice_notes: str | None = Field(default=None)
    is_taxable: bool | None = Field(default=None)
    metadata: dict[str, Any] | None = Field(default=None)
    tax_detail: dict[str, Any] | None = Field(default=None)
    accounting_detail: dict[str, Any] | None = Field(default=None)
    tiers: list[dict[str, Any]] | None = Field(default=None)
    tax_providers_fields: list[dict[str, Any]] | None = Field(default=None)
    object_: str | None = Field(default=None, alias="object")
    channel: str | None = Field(default=None)
    show_description_in_invoices: bool | None = Field(default=None)
    show_description_in_quotes: bool | None = Field(default=None)
    business_entity_id: str | None = Field(default=None)
    deleted: bool | None = Field(default=None)
...
class ItemPriceListListItem(BaseModel):
    ...
    item_price: ItemPrice | None = Field(default=None)

class ItemPriceList(BaseModel):
    """Paginated list of item prices"""
    model_config = ConfigDict(extra="allow", populate_by_name=True)

    list_: list[ItemPriceListListItem] | None = Field(default=None, alias="list")
    next_offset: str | None = Field(default=None)
...
class PaymentSource(BaseModel):
    ...
    issuing_country: str | None = Field(default=None)
    created_at: int | None = Field(default=None)
    updated_at: int | None = Field(default=None)
    resource_version: int | None = Field(default=None)
    deleted: bool | None = Field(default=None)
    ...
    bank_account: dict[str, Any] | None = Field(default=None)
    amazon_payment: dict[str, Any] | None = Field(default=None)
    paypal: dict[str, Any] | None = Field(default=None)
    upi: dict[str, Any] | None = Field(default=None)
    mandates: dict[str, Any] | None = Field(default=None)
    custom_fields: list[dict[str, Any]] | None = Field(default=None)
...
class PaymentSourceListListItem(BaseModel):
    ...
    payment_source: PaymentSource | None = Field(default=None)

class PaymentSourceList(BaseModel):
    """Paginated list of payment sources"""
    model_config = ConfigDict(extra="allow", populate_by_name=True)

    list_: list[PaymentSourceListListItem] | None = Field(default=None, alias="list")
    next_offset: str | None = Field(default=None)
