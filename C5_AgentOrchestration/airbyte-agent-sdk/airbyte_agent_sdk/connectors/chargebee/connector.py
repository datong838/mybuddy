...
from .models import ChargebeeAuthConfig
if TYPE_CHECKING:
    from .models import ChargebeeReplicationConfig
...
class ChargebeeConnector:
    ...
    _ENVELOPE_MAP = {
        ...
        ("item", "list"): True,
        ("item", "get"): None,
        ("item_price", "list"): True,
        ("item_price", "get"): None,
        ("payment_source", "list"): True,
        ("payment_source", "get"): None,
    }

    # Map of (entity, action) -> {python_param_name: api_param_name}
    # Used to convert snake_case TypedDict keys to API parameter names in execute()
    _PARAM_MAP = {
        ('customer', 'list'): {'limit': 'limit', 'offset': 'offset'},
        ('customer', 'get'): {'id': 'id'},
        ('subscription', 'list'): {'limit': 'limit', 'offset': 'offset'},
        ('subscription', 'get'): {'id': 'id'},
        ('invoice', 'list'): {'limit': 'limit', 'offset': 'offset'},
        ('invoice', 'get'): {'id': 'id'},
        ('credit_note', 'list'): {'limit': 'limit', 'offset': 'offset'},
        ('credit_note', 'get'): {'id': 'id'},
        ('coupon', 'list'): {'limit': 'limit', 'offset': 'offset'},
        ('coupon', 'get'): {'id': 'id'},
        ('transaction', 'list'): {'limit': 'limit', 'offset': 'offset'},
        ('transaction', 'get'): {'id': 'id'},
        ('event', 'list'): {'limit': 'limit', 'offset': 'offset'},
        ('event', 'get'): {'id': 'id'},
        ('order', 'list'): {'limit': 'limit', 'offset': 'offset'},
        ('order', 'get'): {'id': 'id'},
        ('item', 'list'): {'limit': 'limit', 'offset': 'offset'},
        ('item', 'get'): {'id': 'id'},
        ('item_price', 'list'): {'limit': 'limit', 'offset': 'offset'},
        ('item_price', 'get'): {'id': 'id'},
        ('payment_source', 'list'): {'limit': 'limit', 'offset': 'offset'},
        ('payment_source', 'get'): {'id': 'id'},
    }

    # Accepted auth_config types for isinstance validation
    _ACCEPTED_AUTH_TYPES = (ChargebeeAuthConfig, AirbyteAuthConfig)

    def __init__(
        self,
        auth_config: ChargebeeAuthConfig | AirbyteAuthConfig | BaseModel | None = None,
        ...
        if is_hosted:
            ...
            self._executor = HostedExecutor(
                ...
                connector_definition_id=str(ChargebeeConnectorModel.id),
                model=ChargebeeConnectorModel,
            )
        else:
            ...
            if not auth_config:
                raise ValueError(
                    ...
                    "or ChargebeeAuthConfig for local mode"
                )
            ...
            if site:
                base_url = base_url.replace("{site}", site)
            self._executor.http_client.base_url = base_url

        # Initialize entity query objects
        self.customer = CustomerQuery(self)
        self.subscription = SubscriptionQuery(self)
        self.invoice = InvoiceQuery(self)
        self.credit_note = CreditNoteQuery(self)
        self.coupon = CouponQuery(self)
        self.transaction = TransactionQuery(self)
        self.event = EventQuery(self)
        self.order = OrderQuery(self)
        self.item = ItemQuery(self)
        self.item_price = ItemPriceQuery(self)
        self.payment_source = PaymentSourceQuery(self)
        ...
        *,
        ...
        if has_extractors:
            ...
            if result.meta is not None:
                return ChargebeeExecuteResultWithMeta[Any, Any](
                    data=result.data,
                    meta=result.meta
                )
            else:
                return ChargebeeExecuteResult[Any](data=result.data)
        else:
    ...
    async def check(self) -> ChargebeeCheckResult:
        """
    ...
    def tool_utils(
        ...
        *,
        ...
        @mcp.tool()
        @ChargebeeConnector.tool_utils(framework="pydantic_ai", internal_retries=2)
        async def execute(entity: str, action: str, params: dict):
            ...
        ```
    ...
    def list_entities(self) -> list[dict[str, Any]]:
        ...
        """
        return describe_entities(ChargebeeConnectorModel)
    ...
    def entity_schema(self, entity: str) -> dict[str, Any] | None:
        ...
        """
        entity_def = next(
            (e for e in ChargebeeConnectorModel.entities if e.name == entity),
            None
        )
        if entity_def is None:
            logging.getLogger(__name__).warning(
                f"Entity '{entity}' not found. Available entities: "
                f"{[e.name for e in ChargebeeConnectorModel.entities]}"
            )
...
class CustomerQuery:
    ...
    def __init__(self, connector: ChargebeeConnector):
    ...
    async def list(
        ...
        **kwargs
        ...
        result = await self._connector.execute("customer", "list", params)
    ...
    async def get(
        ...
        **kwargs
        ...
        result = await self._connector.execute("customer", "get", params)
        return result
    ...
    async def context_store_search(
        ...
        result = await self._connector.execute("customer", "context_store_search", params)

        # Parse response into typed result
        meta_data = result.get("meta")
        return CustomerSearchResult(
            data=[
                CustomerSearchData(**row)
...
class SubscriptionQuery:
    ...
    async def list(
        ...
        **kwargs
        ...
        result = await self._connector.execute("subscription", "list", params)
        # Cast generic envelope to concrete typed result
    ...
    async def get(
        ...
        **kwargs
        ...
        result = await self._connector.execute("subscription", "get", params)
        return result
    ...
    async def context_store_search(
        ...
        result = await self._connector.execute("subscription", "context_store_search", params)

        # Parse response into typed result
        meta_data = result.get("meta")
        return SubscriptionSearchResult(
            data=[
                SubscriptionSearchData(**row)
                for row in result.get("data", [])
                if isinstance(row, dict)
            ],
            meta=AirbyteSearchMeta(
...
class InvoiceQuery:
    ...
    async def list(
        ...
        **kwargs
        ...
        result = await self._connector.execute("invoice", "list", params)
        # Cast generic envelope to concrete typed result
    ...
    async def get(
        ...
        **kwargs
        ...
        result = await self._connector.execute("invoice", "get", params)
        return result
    ...
    async def context_store_search(
        ...
        result = await self._connector.execute("invoice", "context_store_search", params)

        # Parse response into typed result
        meta_data = result.get("meta")
        return InvoiceSearchResult(
            data=[
                InvoiceSearchData(**row)
                for row in result.get("data", [])
                if isinstance(row, dict)
            ],
            meta=AirbyteSearchMeta(
...
class CreditNoteQuery:
    ...
    async def list(
        ...
        **kwargs
        ...
        result = await self._connector.execute("credit_note", "list", params)
        # Cast generic envelope to concrete typed result
    ...
    async def get(
        ...
        **kwargs
        ...
        result = await self._connector.execute("credit_note", "get", params)
        return result
    ...
    async def context_store_search(
        ...
        result = await self._connector.execute("credit_note", "context_store_search", params)

        # Parse response into typed result
        meta_data = result.get("meta")
        return CreditNoteSearchResult(
            data=[
                CreditNoteSearchData(**row)
                for row in result.get("data", [])
                if isinstance(row, dict)
            ],
            meta=AirbyteSearchMeta(
...
class CouponQuery:
    ...
    async def list(
        ...
        **kwargs
        ...
        result = await self._connector.execute("coupon", "list", params)
        # Cast generic envelope to concrete typed result
    ...
    async def get(
        ...
        **kwargs
        ...
        result = await self._connector.execute("coupon", "get", params)
        return result
    ...
    async def context_store_search(
        ...
        result = await self._connector.execute("coupon", "context_store_search", params)

        # Parse response into typed result
        meta_data = result.get("meta")
        return CouponSearchResult(
            data=[
                CouponSearchData(**row)
                for row in result.get("data", [])
                if isinstance(row, dict)
            ],
            meta=AirbyteSearchMeta(
...
class TransactionQuery:
    ...
    async def list(
        ...
        **kwargs
        ...
        result = await self._connector.execute("transaction", "list", params)
        # Cast generic envelope to concrete typed result
    ...
    async def get(
        ...
        **kwargs
        ...
        result = await self._connector.execute("transaction", "get", params)
        return result
    ...
    async def context_store_search(
        ...
        result = await self._connector.execute("transaction", "context_store_search", params)

        # Parse response into typed result
        meta_data = result.get("meta")
        return TransactionSearchResult(
            data=[
                TransactionSearchData(**row)
                for row in result.get("data", [])
                if isinstance(row, dict)
            ],
            meta=AirbyteSearchMeta(
...
class EventQuery:
    ...
    async def list(
        ...
        **kwargs
        ...
        result = await self._connector.execute("event", "list", params)
        # Cast generic envelope to concrete typed result
    ...
    async def get(
        ...
        **kwargs
        ...
        result = await self._connector.execute("event", "get", params)
        return result
    ...
    async def context_store_search(
        ...
        result = await self._connector.execute("event", "context_store_search", params)
...
class OrderQuery:
    ...
    async def list(
        ...
        **kwargs
        ...
        result = await self._connector.execute("order", "list", params)
        # Cast generic envelope to concrete typed result
    ...
    async def get(
        ...
        **kwargs
        ...
        result = await self._connector.execute("order", "get", params)
        return result
    ...
    async def context_store_search(
        ...
        result = await self._connector.execute("order", "context_store_search", params)
...
class ItemQuery:
    ...
    async def list(
        ...
        **kwargs
        ...
        result = await self._connector.execute("item", "list", params)
        # Cast generic envelope to concrete typed result
    ...
    async def get(
        ...
        **kwargs
        ...
        result = await self._connector.execute("item", "get", params)
        return result
    ...
    async def context_store_search(
        ...
        result = await self._connector.execute("item", "context_store_search", params)
...
class ItemPriceQuery:
    ...
    async def list(
        ...
        **kwargs
        ...
        result = await self._connector.execute("item_price", "list", params)
        # Cast generic envelope to concrete typed result
    ...
    async def get(
        ...
        **kwargs
        ...
        result = await self._connector.execute("item_price", "get", params)
        return result
    ...
    async def context_store_search(
        ...
        result = await self._connector.execute("item_price", "context_store_search", params)

        # Parse response into typed result
        meta_data = result.get("meta")
        return ItemPriceSearchResult(
            data=[
                ItemPriceSearchData(**row)
                for row in result.get("data", [])
                if isinstance(row, dict)
            ],
            meta=AirbyteSearchMeta(
...
class PaymentSourceQuery:
    ...
    async def list(
        ...
        **kwargs
        ...
        result = await self._connector.execute("payment_source", "list", params)
        # Cast generic envelope to concrete typed result
    ...
    async def get(
        ...
        **kwargs
        ...
        result = await self._connector.execute("payment_source", "get", params)
        return result
    ...
    async def context_store_search(
        self,
        query: PaymentSourceSearchQuery,
        limit: int | None = None,
        cursor: str | None = None,
        fields: list[list[str]] | None = None,
    ) -> PaymentSourceSearchResult:
        ...
        result = await self._connector.execute("payment_source", "context_store_search", params)

        # Parse response into typed result
        meta_data = result.get("meta")
        return PaymentSourceSearchResult(
            data=[
                PaymentSourceSearchData(**row)
                for row in result.get("data", [])
                if isinstance(row, dict)
            ],
            meta=AirbyteSearchMeta(
