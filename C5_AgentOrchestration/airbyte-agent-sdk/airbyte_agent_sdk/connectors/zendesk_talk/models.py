...
class PhoneNumberCapabilities(BaseModel):
    ...
    emergency_address: bool | None | None = Field(default=None)
...
class PhoneNumber(BaseModel):
    ...
    call_recording_consent: str | None = Field(default=None)
    capabilities: PhoneNumberCapabilities | None = Field(default=None)
    categorised_greetings: dict[str, Any] | None = Field(default=None)
    categorised_greetings_with_sub_settings: dict[str, Any] | None = Field(default=None)
    country_code: str | None = Field(default=None)
    created_at: str | None = Field(default=None)
    default_greeting_ids: list[str] | None = Field(default=None)
    default_group_id: int | None = Field(default=None)
    display_number: str | None = Field(default=None)
    external: bool | None = Field(default=None)
    failover_number: str | None = Field(default=None)
    greeting_ids: list[int] | None = Field(default=None)
    group_ids: list[int] | None = Field(default=None)
    ivr_id: int | None = Field(default=None)
    line_type: str | None = Field(default=None)
    location: str | None = Field(default=None)
    name: str | None = Field(default=None)
    nickname: str | None = Field(default=None)
    number: str | None = Field(default=None)
    outbound_enabled: bool | None = Field(default=None)
    priority: int | None = Field(default=None)
    recorded: bool | None = Field(default=None)
    schedule_id: int | None = Field(default=None)
    sms_enabled: bool | None = Field(default=None)
    sms_group_id: int | None = Field(default=None)
    token: str | None = Field(default=None)
    toll_free: bool | None = Field(default=None)
    transcription: bool | None = Field(default=None)
...
class PhoneNumbersList(BaseModel):
    ...
    phone_numbers: list[PhoneNumber] | None = Field(default=None)
...
class Greeting(BaseModel):
    ...
    audio_name: str | None = Field(default=None)
    audio_url: str | None = Field(default=None)
    category_id: int | None = Field(default=None)
    default: bool | None = Field(default=None)
    default_lang: bool | None = Field(default=None)
    has_sub_settings: bool | None = Field(default=None)
    ivr_ids: list[Any] | None = Field(default=None)
    name: str | None = Field(default=None)
    pending: bool | None = Field(default=None)
    phone_number_ids: list[Any] | None = Field(default=None)
...
class GreetingsList(BaseModel):
    ...
    greetings: list[Greeting] | None = Field(default=None)
    next_page: str | None = Field(default=None)
    previous_page: str | None = Field(default=None)
    count: int | None = Field(default=None)
...
class GreetingWrapper(BaseModel):
    ...
    greeting: Greeting | None = Field(default=None)
...
class GreetingCategoriesList(BaseModel):
    ...
    greeting_categories: list[GreetingCategory] | None = Field(default=None)
    next_page: str | None = Field(default=None)
    previous_page: str | None = Field(default=None)
    count: int | None = Field(default=None)
...
class GreetingCategoryWrapper(BaseModel):
    ...
    greeting_category: GreetingCategory | None = Field(default=None)
...
class IvrMenusItemRoutesItem(BaseModel):
    ...
    greeting: str | None | None = Field(default=None)
    keypress: str | None | None = Field(default=None)
    option_text: str | None | None = Field(default=None)
    options: dict[str, Any] | None | None = Field(default=None)
    overflow_options: list[Any] | None | None = Field(default=None)
...
class IvrMenusItem(BaseModel):
    ...
    default: bool | None | None = Field(default=None)
    greeting_id: int | None | None = Field(default=None)
    routes: list[IvrMenusItemRoutesItem] | None | None = Field(default=None)
...
class Ivr(BaseModel):
    ...
    name: str | None = Field(default=None)
    phone_number_ids: list[Any] | None = Field(default=None)
    phone_number_names: list[Any] | None = Field(default=None)
    menus: list[IvrMenusItem] | None = Field(default=None)

class IvrsList(BaseModel):
    """IvrsList type definition"""
    model_config = ConfigDict(extra="allow", populate_by_name=True)

    ivrs: list[Ivr] | None = Field(default=None)
    next_page: str | None = Field(default=None)
    previous_page: str | None = Field(default=None)
    count: int | None = Field(default=None)
...
class IvrWrapper(BaseModel):
    ...
    ivr: Ivr | None = Field(default=None)
...
class AgentActivity(BaseModel):
    ...
    agent_state: str | None = Field(default=None)
    available_time: int | None = Field(default=None)
    avatar_url: str | None = Field(default=None)
    away_time: int | None = Field(default=None)
    call_status: str | None = Field(default=None)
    calls_accepted: int | None = Field(default=None)
    calls_denied: int | None = Field(default=None)
    calls_missed: int | None = Field(default=None)
    forwarding_number: str | None = Field(default=None)
    name: str | None = Field(default=None)
    online_time: int | None = Field(default=None)
    total_call_duration: int | None = Field(default=None)
    total_talk_time: int | None = Field(default=None)
    total_wrap_up_time: int | None = Field(default=None)
    transfers_only_time: int | None = Field(default=None)
    via: str | None = Field(default=None)
    accepted_third_party_conferences: int | None = Field(default=None)
    accepted_transfers: int | None = Field(default=None)
    average_hold_time: int | None = Field(default=None)
    average_talk_time: int | None = Field(default=None)
    average_wrap_up_time: int | None = Field(default=None)
    calls_put_on_hold: int | None = Field(default=None)
    started_third_party_conferences: int | None = Field(default=None)
    started_transfers: int | None = Field(default=None)
    total_hold_time: int | None = Field(default=None)

class AgentsActivityList(BaseModel):
    """AgentsActivityList type definition"""
    model_config = ConfigDict(extra="allow", populate_by_name=True)

    agents_activity: list[AgentActivity] | None = Field(default=None)
    next_page: str | None = Field(default=None)
    previous_page: str | None = Field(default=None)
    count: int | None = Field(default=None)
...
class AgentsOverview(BaseModel):
    ...
    average_calls_accepted: int | None = Field(default=None)
    average_calls_denied: int | None = Field(default=None)
    average_calls_missed: int | None = Field(default=None)
    average_wrap_up_time: int | None = Field(default=None)
    total_calls_accepted: int | None = Field(default=None)
    total_calls_denied: int | None = Field(default=None)
    total_calls_missed: int | None = Field(default=None)
    total_talk_time: int | None = Field(default=None)
    total_wrap_up_time: int | None = Field(default=None)
    average_accepted_transfers: int | None = Field(default=None)
    average_available_time: int | None = Field(default=None)
    average_away_time: int | None = Field(default=None)
    average_calls_put_on_hold: int | None = Field(default=None)
    average_hold_time: int | None = Field(default=None)
    average_online_time: int | None = Field(default=None)
    average_started_transfers: int | None = Field(default=None)
    average_talk_time: int | None = Field(default=None)
    average_transfers_only_time: int | None = Field(default=None)
    current_timestamp: int | None = Field(default=None)
    total_accepted_transfers: int | None = Field(default=None)
    total_calls_put_on_hold: int | None = Field(default=None)
    total_hold_time: int | None = Field(default=None)
    total_started_transfers: int | None = Field(default=None)

class AgentsOverviewResponse(BaseModel):
    """AgentsOverviewResponse type definition"""
    model_config = ConfigDict(extra="allow", populate_by_name=True)

    agents_overview: AgentsOverview | None = Field(default=None)

class AccountOverview(BaseModel):
    """AccountOverview type definition"""
    model_config = ConfigDict(extra="allow", populate_by_name=True)

    average_call_duration: int | None = Field(default=None)
    average_callback_wait_time: int | None = Field(default=None)
    average_hold_time: int | None = Field(default=None)
    average_queue_wait_time: int | None = Field(default=None)
    average_time_to_answer: int | None = Field(default=None)
    average_wrap_up_time: int | None = Field(default=None)
    current_timestamp: int | None = Field(default=None)
    max_calls_waiting: int | None = Field(default=None)
    max_queue_wait_time: int | None = Field(default=None)
    total_call_duration: int | None = Field(default=None)
    total_callback_calls: int | None = Field(default=None)
    total_calls: int | None = Field(default=None)
    total_calls_abandoned_in_queue: int | None = Field(default=None)
    total_calls_outside_business_hours: int | None = Field(default=None)
    total_calls_with_exceeded_queue_wait_time: int | None = Field(default=None)
    total_calls_with_requested_voicemail: int | None = Field(default=None)
    total_embeddable_callback_calls: int | None = Field(default=None)
    total_hold_time: int | None = Field(default=None)
    total_inbound_calls: int | None = Field(default=None)
    total_outbound_calls: int | None = Field(default=None)
    total_textback_requests: int | None = Field(default=None)
    total_voicemails: int | None = Field(default=None)
    total_wrap_up_time: int | None = Field(default=None)
...
class AccountOverviewResponse(BaseModel):
    ...
    account_overview: AccountOverview | None = Field(default=None)

class CurrentQueueActivity(BaseModel):
    """CurrentQueueActivity type definition"""
    model_config = ConfigDict(extra="allow", populate_by_name=True)

    agents_online: int | None = Field(default=None)
    average_wait_time: int | None = Field(default=None)
    callbacks_waiting: int | None = Field(default=None)
    calls_waiting: int | None = Field(default=None)
    current_timestamp: int | None = Field(default=None)
    embeddable_callbacks_waiting: int | None = Field(default=None)
    longest_wait_time: int | None = Field(default=None)
    ai_agent_calls: int | None = Field(default=None)

class CurrentQueueActivityResponse(BaseModel):
    """CurrentQueueActivityResponse type definition"""
    model_config = ConfigDict(extra="allow", populate_by_name=True)

    current_queue_activity: CurrentQueueActivity | None = Field(default=None)
...
class Call(BaseModel):
    ...
    id: int | None = Field(default=None)
    agent_id: int | None = Field(default=None)
    call_charge: str | None = Field(default=None)
    call_group_id: int | None = Field(default=None)
    call_recording_consent: str | None = Field(default=None)
    call_recording_consent_action: str | None = Field(default=None)
    call_recording_consent_keypress: str | None = Field(default=None)
    callback: bool | None = Field(default=None)
    callback_source: str | None = Field(default=None)
    completion_status: str | None = Field(default=None)
    consultation_time: int | None = Field(default=None)
    created_at: str | None = Field(default=None)
    customer_requested_voicemail: bool | None = Field(default=None)
    default_group: bool | None = Field(default=None)
    direction: str | None = Field(default=None)
    duration: int | None = Field(default=None)
    exceeded_queue_time: bool | None = Field(default=None)
    exceeded_queue_wait_time: bool | None = Field(default=None)
    hold_time: int | None = Field(default=None)
    ivr_action: str | None = Field(default=None)
    ivr_destination_group_name: str | None = Field(default=None)
    ivr_hops: int | None = Field(default=None)
    ivr_routed_to: str | None = Field(default=None)
    ivr_time_spent: int | None = Field(default=None)
    minutes_billed: int | None = Field(default=None)
    not_recording_time: int | None = Field(default=None)
    outside_business_hours: bool | None = Field(default=None)
    overflowed: bool | None = Field(default=None)
    overflowed_to: str | None = Field(default=None)
    phone_number: str | None = Field(default=None)
    phone_number_id: int | None = Field(default=None)
    quality_issues: list[str] | None = Field(default=None)
    recording_control_interactions: int | None = Field(default=None)
    recording_time: int | None = Field(default=None)
    talk_time: int | None = Field(default=None)
    ticket_id: int | None = Field(default=None)
    time_to_answer: int | None = Field(default=None)
    updated_at: str | None = Field(default=None)
    voicemail: bool | None = Field(default=None)
    wait_time: int | None = Field(default=None)
    wrap_up_time: int | None = Field(default=None)
    customer_id: int | None = Field(default=None)
    line: str | None = Field(default=None)
    line_id: int | None = Field(default=None)
    line_type: str | None = Field(default=None)
    call_channel: str | None = Field(default=None)
    post_call_transcription_created: bool | None = Field(default=None)
    post_call_summary_created: bool | None = Field(default=None)
...
class CallLeg(BaseModel):
    ...
    agent_id: int | None = Field(default=None)
    available_via: str | None = Field(default=None)
    call_charge: str | None = Field(default=None)
    call_id: int | None = Field(default=None)
    completion_status: str | None = Field(default=None)
    conference_from: int | None = Field(default=None)
    conference_time: int | None = Field(default=None)
    conference_to: int | None = Field(default=None)
    consultation_from: int | None = Field(default=None)
    consultation_time: int | None = Field(default=None)
    consultation_to: int | None = Field(default=None)
    created_at: str | None = Field(default=None)
    duration: int | None = Field(default=None)
    forwarded_to: str | None = Field(default=None)
    hold_time: int | None = Field(default=None)
    minutes_billed: int | None = Field(default=None)
    quality_issues: list[str] | None = Field(default=None)
    talk_time: int | None = Field(default=None)
    transferred_from: int | None = Field(default=None)
...
class CallLegsList(BaseModel):
    ...
    legs: list[CallLeg] | None = Field(default=None)
    next_page: str | None = Field(default=None)
    count: int | None = Field(default=None)
    end_time: int | None = Field(default=None)
