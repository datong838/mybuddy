  ...
  const renderLogo = () => {
    const appTitle =
      systemFeatures.branding.enabled && systemFeatures.branding.application_title
        ...
        : 'Dify'
    const showCustomLogo = Boolean(
      systemFeatures.branding.enabled && systemFeatures.branding.workspace_logo,
    )
    const showBrandText = Boolean(
      systemFeatures.branding.enabled && systemFeatures.branding.application_title && !showCustomLogo,
    )
    ...
    return (
      ...
      >
        {showCustomLogo ? (
          ...
          <span className="truncate px-1 text-[15px] font-semibold tracking-tight text-text-primary">
            {appTitle}
          </span>
        ) : (
          <DifyLogo alt="" />
